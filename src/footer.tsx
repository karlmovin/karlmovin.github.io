export default function Footer() {
  return (
    <footer className="flex flex-row flex-wrap container max-w-screen-xl items-center justify-center w-full py-6 text-center border-t gap-y-6 gap-x-12 border-blue-gray-50 md:justify-between">
      ...
      <ul className="flex flex-wrap items-center gap-y-2 gap-x-8">
        <li>
          <a
            href="https://github.com/karlmovin"
